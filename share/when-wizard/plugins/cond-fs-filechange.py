# file: share/when-wizard/plugins/cond-fs-filechange.py
# -*- coding: utf-8 -*-
#
...
HELP = _("""\
This condition can be used to monitor a single file: when any changes occur
on it, the event will fire up and trigger a consequence.
""")
...
class Plugin(FileChangeConditionPlugin):
    ...
    def change_filename(self, obj):
        ...
        if self.watched_path:
            ...
            self.summary_description = _("When the file '%s' changes") % base
